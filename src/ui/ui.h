...
extern lv_obj_t *ui_PanelPwControl;
extern lv_obj_t *ui_ImagePwControl;
extern lv_obj_t *ui_TextPwControl;
void ui_event_PwControl( lv_event_t * e);
extern lv_obj_t *ui_PwControl;
...
LV_IMG_DECLARE( ui_img_1093450328);   // assets/ic_outline-power.png
